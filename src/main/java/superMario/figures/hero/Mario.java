...
import superMario.manager.Camera;
...
public class Mario extends Afigures{
    ...
    public Mario(double x, double y){
        ...
        Image[] leftFrames = imageLoader.getLeftFrames(MarioForm.SMALL);
        Image[] rightFrames = imageLoader.getRightFrames(MarioForm.SMALL);
