...
public class MarioForm {
    ...
    public Image getCurrentStyle(boolean toRight, boolean movingInX, boolean movingInY){
    ...
    public MarioForm onTouchEnemy(ImageLoader imageLoader) {
        Image[] leftFrames = imageLoader.getLeftFrames(0);
        Image[] rightFrames= imageLoader.getRightFrames(0);
